...
<!--         
        <div id="sidebar" class="fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0">
            ...
            <div id="sidebar__inner" class="flex sside md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700">
                  ...
                  <div
                                class=" sm:block lg:block hidden h-10 text-slate-600 px-4 max-md:fixed text-3xl font-bold  max-md:top-0 max-md:w-full max-md:bg-white/80 max-md:left-0 max-md:px-4 max-md:h-14 max-md:shadow-sm max-md:dark:bg-slate-900/80 backdrop-blur-xl">
                            SciNetHub
                            </div>

          
                <nav class="flex-1 mt-5 max-md:flex max-md:justify-around md:space-y-2">
                    ...
                    <a href="home.html" class=" flex" >
                        ...
                        <span class="max-xl:hidden mr-[60%] text-gray-500"> Home </span>
                    </a>
                    ...
                    <a href="#!" class=" flex" >
                        ...
                        <span class="max-xl:hidden mr-[60%] text-gray-500"> Search </span>
                    </a>  
                    ...
                    <a href="explore.html" class="max-md:!hidden flex">
                        ...
                        <span class="max-xl:hidden mr-[60%] text-gray-500 sm:mt-[-6px]"> Explore </span>
                    </a>  

                    <a href="messages.html" class="max-md:!fixed max-md:top-2 flex max-md:right-2">
                        <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        ...
                        <span class="max-xl:hidden mr-[52%] sm:mt-[-3px] text-gray-500"> Messages </span>
                    </a>
                    
                   
                    <a href="reels.html" class="flex" >
                        ...
                        <span class="max-xl:hidden mr-[60%] text-gray-500 "> reels </span>
                    </a>
                    ...
                    <a href="profile.html" class="max-md:!hidden active">
        ...
        <div id="sidebar" class="fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0">
            ...
            <div id="sidebar__inner" class="flex sside md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700">
                ...
                <nav class="flex-1 max-md:flex max-md:justify-around md:space-y-2">
                    ...
                    <a href="messages.html" class="max-md:!fixed max-md:top-2 max-md:right-2">
                        <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z"></path>
                        </svg>
                        <svg id="icon__solid" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" fill="currentColor" class="hidden">
